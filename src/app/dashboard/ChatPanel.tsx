...
const MESSAGES: Msg[] = [
  ...
  { id: 11, name: "mahbianchi", text: "meninas mais um lance de r$ 380 aqui", minutesAgo: 1240 },
  ...
  { id: 202, name: "dieniferbrum_", text: "fechando outro mes com mais de 5k, to quase pedindo as contas do meu emprego atual", minutesAgo: 9 },
  ...
  { id: 23, name: "helooo_priv", text: "eu nem respondo ninguém desses arabes, só vendo e deu, fora que a tradução do chat não ajuda tambem", minutesAgo: 1188, replyTo: 19 },
  ...
  { id: 41, name: "manuelaaa.b", text: "primeira venda do mes caiu agora!!! R$ 290!!!! ❤️‍🔥", minutesAgo: 1050 },
  ...
  { id: 94, name: "luvendinha", text: "lapela do shopee dura pouco, melhor investir num bom", minutesAgo: 640, replyTo: 91 },
  ...
  { id: 99, name: "mahirambo", text: "minha vizinha curiosa começou a perguntar com o q eu trabalho, q saco kkk", minutesAgo: 560 },
  { id: 100, name: "dieniferbrum_", text: "n conta nada, fica vaga, não é da conta de ninguem,", minutesAgo: 555, replyTo: 99 },
  ...
  { id: 104, name: "mahirambo", text: "kkkkkkkkk boa", minutesAgo: 547, replyTo: 99 },
  { id: 106, name: "carolperola", text: "voltei de uma soneca enorme kkk dormi muito", minutesAgo: 460 },
  ...
  { id: 109, name: "manuelaaa.b", text: "alguem já enviou foto mostrando o rosto ou parte do corpo?", minutesAgo: 420 },
  { id: 110, name: "claradalmaa", text: "rosto nao, jamais", minutesAgo: 415, replyTo: 109 },
  { id: 111, name: "yasmim__real", text: "corpo só parte dele ja mostrei, mas rosto nunca", minutesAgo: 413, replyTo: 109 },
  { id: 112, name: "onlypes_aananda", text: "ja mostrei o rosto algumas vezes mas n ligo, eh so pro arabe q comprou, ele nunca vai me ver na vida", minutesAgo: 411, replyTo: 109 },
  { id: 113, name: "leticia_priv", text: "rosto nao, mas se pagar muito bem, ninguem nunca vai ver mesmo né", minutesAgo: 409, replyTo: 109 },
  { id: 114, name: "viviana_oficial", text: "tenho umas tatuagens na perna e coxa, sempre mostro sem problema", minutesAgo: 407, replyTo: 109 },
  { id: 225, name: "manuelaaa.b", text: "anotando td, obg meninas", minutesAgo: 405, replyTo: 109 },
  ...
  { id: 119, name: "lariis.priv", text: "como vcs lidam com os pedidos especiais? o tradutor da plataforma ta uma porcaria, sempre traduz errado, sao os que mais pagam mas sempre envio errado por conta do tradutor", minutesAgo: 340 },
  { id: 120, name: "Brunaprivy", text: "lariii o google tradutor eh melhor q o da plataforma, juro", minutesAgo: 335, replyTo: 119 },
  { id: 121, name: "mahbianchi", text: "uso o deepl, traduz arabe bem melhor q o google", minutesAgo: 333, replyTo: 119 },
  { id: 122, name: "isafoot_22", text: "as vezes eles pedem umas coisas esquisita e eu n entendo, só entendo o 'pisar' mas nao entendo o objeto ou posicao que eles pedem, o pior é que pedidos especiais são os que pagam melhor", minutesAgo: 331, replyTo: 119 },
  ...
  { id: 230, name: "gabivendeoficial", text: "PARABEEENS amg 🎉🎉🎉 merecido demais", minutesAgo: 235, replyTo: 229 },
  { id: 231, name: "isafoot_22", text: "UHUUL 👏👏👏 arrasou", minutesAgo: 232, replyTo: 229 },
  ...
  { id: 135, name: "viviana_oficial", text: "gente preciso desabafar, esses caras q ficam mandando 'oi linda' em arabe achando q sao especiais", minutesAgo: 230 },
  ...
  { id: 139, name: "babi_doll", text: "eles nunca viram nosso rosto nem corpo e chamam de linda, tem que ter muito fetiche por pé mesmo kk", minutesAgo: 221, replyTo: 135 },
  { id: 142, name: "gabivendeoficial", text: "gente, tem cara querendo q eu mande video pisando em uma laranja com o pe 🍊 KKKK", minutesAgo: 220 },
  { id: 143, name: "Pesdaamanda", text: "menina o que", minutesAgo: 215, replyTo: 142 },
  { id: 144, name: "gabivendeoficial", text: "to falando, e paga 340!! vou tentar kkk", minutesAgo: 213, replyTo: 142 },
  ...
  { id: 149, name: "leticia_priv", text: "isa, ja é o que? quinto?", minutesAgo: 175, replyTo: 148 },
  ...
  { id: 176, name: "manuelaaa.b", text: "consegui meu 8o pagamento, fechei o mes com R$ 2.280 (sou novata) ❤️", minutesAgo: 55 },
  { id: 177, name: "Pesdaamanda", text: "maravilha Manu, vc ta indo rapido!!", minutesAgo: 50, replyTo: 176 },
  { id: 178, name: "lariis.priv", text: "primeiros meses eh assim, daqui a 6 meses vc ta em 5k tranquilo", minutesAgo: 48, replyTo: 176 },
  ...
  { id: 228, name: "jubea_01", text: "esquece, ja achei aqui, obrigada flor", minutesAgo: 13, replyTo: 226 },
...
const AVATAR_URLS: Record<string, string> = {
  ...
  "jubea_01": "https://i.pinimg.com/736x/5a/ed/61/5aed6199960b5d108d443c9cd5e18b0b.jpg",
  "a_karenlps": "https://i.pinimg.com/736x/c3/f6/66/c3f666fd73f72c6507934b136acf38d1.jpg",
  ...
  "pesfof1nhos": "https://i.pinimg.com/1200x/df/c4/42/dfc442cbef0d9c5e1e60aebf8357d215.jpg",
};
...
export function ChatPanel({ userName, compact = false, hasActivePlan = false, forceBlocked = false }: { userName: string; compact?: boolean; hasActivePlan?: boolean; forceBlocked?: boolean }) {
  ...
  function handleSendWelcome(text: string) {
    ...
    // Direct privado da gaby_mypriv: marca timestamp + agenda chegada da 1a mensagem
    const lariisStartTs = Date.now();
    try {
      localStorage.setItem("footpriv_lariis_start_ts", String(lariisStartTs));
    } catch {}
    setTimeout(() => {
